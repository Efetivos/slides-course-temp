...
import { withAsyncContext, mergeProps, useSSRContext } from 'file:///Users/victorcosta/Documents/DEV/experiments/courses-slides-testing/node_modules/vue/index.mjs';
import { ssrRenderAttrs } from 'file:///Users/victorcosta/Documents/DEV/experiments/courses-slides-testing/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(async () => useAsyncData(async () => {
      const document = await client.getAllByType("slide");
      return document;
    }, "$PslAyef5YX")), __temp = await __temp, __restore();
    useHead({
...
//# sourceMappingURL=index-c88d5844.mjs.map
