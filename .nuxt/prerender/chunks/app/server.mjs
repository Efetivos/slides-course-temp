...
import { defineHeadPlugin } from 'file:///Users/victorcosta/Documents/DEV/experiments/courses-slides-testing/node_modules/@unhead/shared/dist/index.mjs';
import { parse } from 'file:///Users/victorcosta/Documents/DEV/experiments/courses-slides-testing/node_modules/cookie-es/dist/index.mjs';
...
import { isEqual } from 'file:///Users/victorcosta/Documents/DEV/experiments/courses-slides-testing/node_modules/ohash/dist/index.mjs';
import { isFilled, asHTML, isRepositoryEndpoint, getRepositoryName, createClient, filter, cookie, asText, asLink, asLinkAttrs, asDate, asImageSrc, asImageWidthSrcSet, asImagePixelDensitySrcSet, documentToLinkField } from 'file:///Users/victorcosta/Documents/DEV/experiments/courses-slides-testing/node_modules/@prismicio/client/dist/index.js';
import { ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderSuspense, ssrRenderVNode } from 'file:///Users/victorcosta/Documents/DEV/experiments/courses-slides-testing/node_modules/vue/server-renderer/index.mjs';
import { defu } from 'file:///Users/victorcosta/Documents/DEV/experiments/courses-slides-testing/node_modules/defu/dist/defu.mjs';
...
const _routes = [
  {
    name: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) ?? "chapter-uid",
    path: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) ?? "/chapter/:uid()",
...
function useCookie(name, _opts) {
  ...
  const cookie2 = ref(cookies[name] ?? ((_a = opts.default) == null ? void 0 : _a.call(opts)));
  {
    const nuxtApp = useNuxtApp();
    const writeFinalCookieValue = () => {
      if (!isEqual(cookie2.value, cookies[name])) {
    ...
    client2 = createClient(options.endpoint, {
      fetch: async (endpoint, options2) => {
        ...
        if (typeof globalThis.fetch === "function") {
          ...
          fetchFunction = (await import('file:///Users/victorcosta/Documents/DEV/experiments/courses-slides-testing/node_modules/isomorphic-unfetch/index.js')).default;
        }
...
class SlideMode {
  ...
  getChapter() {
    ...
    this.current_index = Array.from(this.$each_chapter).findIndex((chapter2) => chapter2.dataset.id === this.anchor);
    this.moveSlide();
  }
  moveSlide() {
  ...
  prevSlide() {
    if (!this.$html.classList.contains("slide-mode"))
      return;
    if (!this.$body.classList.contains("chapter"))
      return;
  ...
  nextSlide() {
    ...
    if (!this.$body.classList.contains("chapter"))
      return;
    if (this.current_index >= this.chapters_length - 1)
      return;
    this.current_index++;
    this.moveSlide();
  }
...
const _sfc_main$6 = {
  methods: {
    toggleMenu(e) {
      document.querySelector("body").classList.toggle("is-menufs");
    },
    toggleMode(e) {
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="menu-ui__items-right"><div class="menu-ui__scheme-trg"><div class="menu-ui__scheme-trg__mode menu-ui__scheme-trg__dark"><svg width="100%" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.17432 11.8229C2.17432 17.9959 7.17846 23 13.3514 23C18.0547 23 22.0794 20.0949 23.7293 15.9814C22.4419 16.4988 21.0332 16.7904 19.5608 16.7904C13.3879 16.7904 8.3838 11.7863 8.3838 5.61335C8.3838 4.14786 8.6711 2.73112 9.18385 1.4487C5.07506 3.10082 2.17432 7.12312 2.17432 11.8229Z" stroke="var(--color)" stroke-width="2.48379" stroke-linecap="round" stroke-linejoin="round"></path></svg></div><div class="menu-ui__scheme-trg__mode menu-ui__scheme-trg__light"><svg width="100%" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18 2.25V4M18 32V33.75M4 18H2.25M8.04971 8.04971L6.625 6.625M27.9503 8.04971L29.375 6.625M8.04971 27.9575L6.625 29.3752M27.9503 27.9575L29.375 29.3752M33.75 18H32M25 18C25 21.8659 21.8659 25 18 25C14.134 25 11 21.8659 11 18C11 14.134 14.134 11 18 11C21.8659 11 25 14.134 25 18Z" stroke="#ffc508" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"></path></svg></div></div><ul class="menu-ui__nav no-mobile"><li class="menu-ui__nav__item">`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    href: "#",
    class: "menu-ui__nav__item__link"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`About`);
  ...
  _push(`</li><li class="menu-ui__nav__item">`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    href: "#",
    class: "menu-ui__nav__item__link"
  }, {
  ...
  _push(`</li></ul><div class="menu-ui__trg-menu no-desk"><svg width="100%" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 9H16" stroke="var(--black)" stroke-width="2"></path><path d="M0 5H16" stroke="var(--black)" stroke-width="2"></path><path d="M0 1H16" stroke="var(--black)" stroke-width="2"></path></svg></div></div></div></div>`);
}
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "slide-counter" }, _attrs))}><div class="slide-counter__current">00</div><div class="slide-counter__slash">/</div><div class="slide-counter__total">00</div></div>`);
}
const _sfc_setup$5 = _sfc_main$5.setup;
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/NumbIndicatorSlider.vue");
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "preloader e-wvw e-hvh" }, _attrs))}><div class="preloader__hold e-rel e-wp e-hp"></div></div>`);
}
...
const _sfc_main$3 = /* @__PURE__ */ Object.assign(__default__$1, {
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => client2.getSingle("homepage")), __temp = await __temp, __restore(), __temp);
    const { data: slides } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData(async () => {
      const document2 = await client2.getAllByType("slide");
      return document2;
              ...
              if (item.slice_type === "doc_item") {
                ...
                ssrRenderList(item.items, (child) => {
                  ...
                  if (child.is_anchor) {
                    ...
                    _push(ssrRenderComponent(_component_NuxtLink, {
                      class: "anchor",
                      to: `/chapter/${post_list.uid}#${child.class}`,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_ListDoc = __nuxt_component_5;
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-9ab8fcd8.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
