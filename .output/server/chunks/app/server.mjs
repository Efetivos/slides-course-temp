import { hasInjectionContext, getCurrentInstance, inject, version, ref, toRef, onServerPrefetch, h, useSSRContext, watchEffect, watch, unref, defineComponent, computed, resolveComponent, nextTick, mergeProps, withCtx, openBlock, createBlock, createVNode, createTextVNode, createApp, reactive, resolveDynamicComponent, provide, onErrorCaptured, shallowRef, shallowReactive, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw, Suspense, Transition } from 'vue';
import { $fetch } from 'ofetch';
import { createHooks } from 'hookable';
import { getContext, executeAsync } from 'unctx';
import { routerKey, createMemoryHistory, createRouter, START_LOCATION, useRoute as useRoute$1 } from 'vue-router';
...
import { isFilled, asHTML, isRepositoryEndpoint, getRepositoryName, createClient, filter, cookie, asText, asLink, asLinkAttrs, asDate, asImageSrc, asImageWidthSrcSet, asImagePixelDensitySrcSet, documentToLinkField } from '@prismicio/client';
...
const _routes = [
  {
    name: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.name) ?? "section-uid",
    path: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.path) ?? "/:section()/:uid()",
    meta: __nuxt_page_meta$3 || {},
    alias: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.alias) || [],
    redirect: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.redirect) || void 0,
    component: () => import('./_nuxt/_uid_-24773c6a.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.name) ?? "uid",
    path: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.path) ?? "/:uid()",
    meta: __nuxt_page_meta$2 || {},
    alias: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.alias) || [],
    redirect: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.redirect) || void 0,
    component: () => import('./_nuxt/_uid_-22350b50.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/_uid_-d1aab48d.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index-b88a832e.mjs').then((m) => m.default || m)
  }
];
...
const plugin_JbOpvgCHAb = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  ...
  const prismicPlugin = createPrismic({
    ...
    components: {
      linkInternalComponent: __nuxt_component_0$2,
      linkExternalComponent: __nuxt_component_0$2,
      ...options.components
    }
  });
...
const layouts = {
  custom: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/custom-18c9746b.mjs').then((m) => m.default || m)),
  default: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/default-f1d051e3.mjs').then((m) => m.default || m))
};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-9f0ba30c.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { Console as C, LayoutMetaSymbol as L, PrismicRichText as P, _export_sfc as _, useRoute as a, useHead as b, createError as c, useAsyncData as d, entry$1 as default, __nuxt_component_0$2 as e, __nuxt_component_0 as f, PageRouteSymbol as g, appPageTransition as h, _wrapIf as i, appKeepalive as j, useNuxtApp as k, transitions as t, usePrismic as u };
